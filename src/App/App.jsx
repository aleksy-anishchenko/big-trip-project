...
import Filters from '../components/filter-list/FilterList'
          ...
          <div className="trip-main">
            <section className="trip-main__trip-info trip-info">
              <div className="trip-info__main">
                <h1 className="trip-info__title">Amsterdam &mdash; Chamonix &mdash; Geneva</h1>
                <p className="trip-info__dates">18&nbsp;&mdash;&nbsp;20 Mar</p>
              </div>
              <p className="trip-info__cost">
                Total: &euro;&nbsp;<span className="trip-info__cost-value">1230</span>
              </p>
            </section>
